...
| `overdraw.card` | <img src="../assets/screenshots/widgets/overdraw-card.png" alt="Overdraw card" width="360"> | Card | Overdraw / Heatmap | Stato della misurazione overdraw, progresso, ratio e stato heatmap; in HDRP puo mostrare unsupported state per overdraw/heatmap. |
