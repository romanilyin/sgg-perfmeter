...
- GRD espone la modalità configurata e il supporto SRP pubblico, ma l'attività è `Unknown` perché la semantica enabled differisce tra Unity 17.4 e 17.5. La telemetria GRD più profonda appartiene a `PM-GRD-001`; questo snapshot non dichiara attività GRD.
