...
SGG PerfMeter e distribuito come pacchetto Unity denominato `com.sungeargames.perfmeter`. La versione npm pubblica attuale e `2026.8.7-1`; Git UPM e la copia locale restano disponibili.
