...
- installare `PerfMeterRenderGraphFeature` nei renderer URP attivi e modificabili;
...
- conferma che il renderer URP attivo abbia `PerfMeterRenderGraphFeature` quando testi diagnostica Render Graph o overdraw.
