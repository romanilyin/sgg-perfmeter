...
| `perfmeter.camera.snapshot` | Lire transform/projection/reglages URP de camera. |
| `perfmeter.rendergraph.snapshot` | Lire les derniers diagnostics PerfMeter Render Graph observes. |
