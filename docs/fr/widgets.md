...
| `overdraw.card` | <img src="../assets/screenshots/widgets/overdraw-card.png" alt="Overdraw card" width="360"> | Carte | Overdraw / Heatmap | Etat de mesure d'overdraw, progression, ratio et etat de heatmap. |
