...
- GRD expose le mode configuré et le support SRP public, mais son activité est `Unknown` car la sémantique enabled diffère entre Unity 17.4 et 17.5. La télémétrie GRD approfondie relève de `PM-GRD-001`; ce snapshot ne prétend pas mesurer l'activité GRD.
