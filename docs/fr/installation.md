...
SGG PerfMeter est distribue comme package Unity nomme `com.sungeargames.perfmeter`. La version npm publique actuelle est `2026.6.11-1`; Git UPM et la copie locale restent disponibles.
