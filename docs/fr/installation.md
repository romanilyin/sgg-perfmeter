...
SGG PerfMeter est distribue comme package Unity nomme `com.sungeargames.perfmeter`. Le package du npm registry public commence a `2026.6.5-2`; Git UPM et la copie locale restent disponibles.
