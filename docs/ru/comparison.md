...
SGG PerfMeter имеет более узкий и диагностический фокус: Unity `6000.4+`, URP `17.4+`, Render Graph, структурированные снимки, экспорт сессий, диагностика overdraw, воспроизводимые метаданные камеры/устройства и автоматизация через MCP/API.
