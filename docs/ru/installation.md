...
SGG PerfMeter распространяется как пакет Unity с именем `com.sungeargames.perfmeter`. Текущая публичная npm-версия: `2026.6.28-1`; установка через Git UPM и локальную копию остается доступной.
