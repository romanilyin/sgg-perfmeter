...
**Легкая runtime-диагностика производительности и профилирование, понятное агентам, для Unity 6 URP.**
...
SGG PerfMeter - легкая runtime-диагностика производительности и профилирование, понятное агентам, для Unity 6 URP.

Находите узкие места кадра, сравнивайте изменения производительности, записывайте воспроизводимые сессии и отдавайте структурированные profiling-данные инструментам и AI-агентам.
...
Используйте [Сравнение](./comparison.md) как контекст по продукту и архитектуре, а не как измеренный runtime-бенчмарк.
