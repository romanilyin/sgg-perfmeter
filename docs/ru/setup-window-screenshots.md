# Скриншоты окна настройки

Окно настройки открывается через `SGG/Perfmeter/Setup`. Эти скриншоты показывают русские страницы UI для настройки проекта, редактирования визуальных пресетов, элементов управления Runtime в Play Mode и сведений Inventory/Debug по виджетам.
