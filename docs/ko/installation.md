...
SGG PerfMeter는 `com.sungeargames.perfmeter`라는 Unity package로 배포됩니다. public npm registry package는 `2026.6.5-2`부터 시작하며 Git UPM과 local copy install도 사용할 수 있습니다.
