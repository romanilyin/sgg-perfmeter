...
| `overdraw.card` | <img src="../assets/screenshots/widgets/overdraw-card.png" alt="Overdraw card" width="360"> | Tarjeta | Overdraw / Heatmap | Estado de medición de overdraw, progreso, ratio y estado de heatmap; en HDRP puede mostrar unsupported state para overdraw/heatmap. |
