...
- GRD informa del modo configurado y del soporte SRP público, pero la actividad es `Unknown` porque la semántica de enabled difiere entre Unity 17.4 y 17.5. La telemetría GRD profunda pertenece a `PM-GRD-001`; este snapshot no afirma actividad de GRD.
