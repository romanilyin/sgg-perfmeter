...
SGG PerfMeter se distribuye como un paquete Unity llamado `com.sungeargames.perfmeter`. La versión pública actual de npm es `2026.8.11-1`; Git UPM y la copia local siguen disponibles.
