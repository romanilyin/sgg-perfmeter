...
SGG PerfMeter wird als Unity-Paket `com.sungeargames.perfmeter` verteilt. Die aktuelle öffentliche npm-Version ist `2026.8.13-2`; Git UPM und lokale Kopien bleiben verfügbar.
