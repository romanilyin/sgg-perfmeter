...
| `overdraw.card` | <img src="../assets/screenshots/widgets/overdraw-card.png" alt="Overdraw card" width="360"> | Card | Overdraw / Heatmap | Overdraw measurement state, progress, ratio und heatmap state; in HDRP kann der Widget unsupported state fuer overdraw/heatmap zeigen. |
