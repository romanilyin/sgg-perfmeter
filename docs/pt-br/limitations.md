...
- GRD expoe o modo configurado e o suporte SRP publico, mas a atividade e `Unknown` porque a semantica de enabled difere entre Unity 17.4 e 17.5. Telemetria GRD mais profunda pertence a `PM-GRD-001`; este snapshot nao afirma atividade GRD.
