...
SGG PerfMeter e intencionalmente mais estreito e mais diagnostico: Unity `6000.4+`, URP `17.4+`, Render Graph, snapshots estruturados, exportacao de sessao, diagnosticos de overdraw, metadados reproduziveis de camera/device e automacao MCP/API.

## Tabela De Comparacao

| Area | SGG PerfMeter | Advanced FPS Counter | Graphy |
| --- | --- | --- | --- |
| Posicionamento principal | 🔵 Diagnosticos URP Render Graph + API de profiling pronta para automacao | ⚠️ Contador flexivel in-game de FPS/memoria/device | ⚠️ Monitor visual de stats de FPS/memoria/audio + debugger |
| Alvo Unity | ⚠️ Unity `6000.4+`, URP `17.4+` | 🔵 Suporte amplo a versoes antigas do Unity | 🔵 Suporte amplo a versoes antigas do Unity |
...
| Overdraw | 🔵 Medicao numerica + heatmap visual por URP Render Graph | 🛑 Nao | 🛑 Nao |
...
- Expoe render counters orientados a URP e diagnosticos de Render Graph.
