...
SGG PerfMeter e distribuido como um pacote Unity chamado `com.sungeargames.perfmeter`. A versao publica atual no npm e `2026.8.9-1`; Git UPM e copia local continuam disponiveis.
