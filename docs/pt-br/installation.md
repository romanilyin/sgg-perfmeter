...
SGG PerfMeter e distribuido como um pacote Unity chamado `com.sungeargames.perfmeter`. A versao publica atual no npm e `2026.8.7-2`; Git UPM e copia local continuam disponiveis.
