...
- GRD reports configured mode and public SRP support, but activity is `Unknown` because Unity 17.4 and 17.5 enabled semantics differ. Deeper GRD telemetry belongs to `PM-GRD-001`; this snapshot does not claim GRD activity.
