...
SGG PerfMeter is distributed as a Unity package named `com.sungeargames.perfmeter`. The current public npm registry package is `2026.8.5-2`; Git UPM and local-copy installs remain available.
