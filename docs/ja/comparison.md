...
| --- | --- | --- | --- |
| Primary positioning | 🔵 URP Render Graph diagnostics + automation-ready profiling API | ⚠️ 柔軟な in-game FPS/memory/device counter | ⚠️ visual FPS/memory/audio stats monitor + debugger |
