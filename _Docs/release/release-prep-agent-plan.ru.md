...
5. Подготовить final checklist перед tag `2026.5.18-1`.
...
`_Docs/sgg-perfmeter-competitor-comparison-updated.md` - локальный reference source, его нельзя коммитить.
