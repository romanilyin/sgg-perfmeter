...
- Next implementation work follows `_Docs/sgg-perfmeter-roadmap-from-competitors.ru.md`: warm-up/reset/scene scope, background/headless collection mode, zero-allocation overlay refresh, samples, JSON tunables, and custom metric providers.
