...
- The `Runtime` tab is for Play Mode: buttons are disabled in Edit Mode, and in Play Mode they switch collection mode, target FPS, overlay mode/corner/theme/layout/font, show or hide the overlay, start a short overdraw measurement, and toggle the overdraw heatmap.
