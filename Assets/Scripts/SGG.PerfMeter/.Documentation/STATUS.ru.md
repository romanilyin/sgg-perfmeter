...
- Editor warning alerts имеют отдельный JSON-настраиваемый cooldown и не пишут warning каждый кадр; default rule thresholds и consecutive-frame windows также редактируются в JSON/Presets.
