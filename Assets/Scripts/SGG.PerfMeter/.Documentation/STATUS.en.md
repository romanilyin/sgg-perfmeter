...
- The `Runtime` tab groups Play Mode controls by status, collection, visibility, target FPS, overlay appearance, CPU core panels, and overdraw; active radio/toggle choices are highlighted.
