...
- Kept the UPM package binary-free. Annotation transport requires a newly published bridge artifact; the currently published `2026.8.11-1` bridge remains capture-compatible and is reported as `BridgeTooOld` for annotations.
